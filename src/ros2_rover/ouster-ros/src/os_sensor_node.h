...
#include "rover_msgs/msg/packet_msg.hpp"
#include "rover_msgs/srv/get_config.hpp"
#include "rover_msgs/srv/set_config.hpp"
...
class OusterSensor : public OusterSensorNodeBase {
   ...
   private:
    ...
    rover_msgs::msg::PacketMsg lidar_packet;
    rover_msgs::msg::PacketMsg imu_packet;
    rclcpp::Publisher<rover_msgs::msg::PacketMsg>::SharedPtr lidar_packet_pub;
    rclcpp::Publisher<rover_msgs::msg::PacketMsg>::SharedPtr imu_packet_pub;
    rclcpp::Service<std_srvs::srv::Empty>::SharedPtr reset_srv;
    rclcpp::Service<rover_msgs::srv::GetConfig>::SharedPtr get_config_srv;
    rclcpp::Service<rover_msgs::srv::SetConfig>::SharedPtr set_config_srv;
