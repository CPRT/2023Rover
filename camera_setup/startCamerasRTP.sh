...
encoder="nvvidconv ! nvv4l2h265enc bitrate=5000000 control-rate=0 maxperf-enable=true insert-sps-pps=true idrinterval=1 iframeinterval=1 profile=1 qos=true ! mux."
